...
(function() {
            ...
            Ext.ComponentMgr.onAvailable('component-add-menu', function(config) {
                ...
                menuButton.menuItems.push({
                    xtype: 'menuitem',
                    text: _t('Add Logical Disk') + '...',
                    hidden: Zenoss.Security.doesNotHavePermission('Manage Device'),
                    handler: function() {
                        var win = new Zenoss.dialog.CloseDialog({
                            width: 300,
                            title: _t('Add Logical Disk'),
                            items: [{
                                xtype: 'form',
                                buttonAlign: 'left',
                                monitorValid: true,
                            ...
                            }, 
                            {
                                ...
                                buttons: [{
                                    ...
                                    handler: function(b) {
                                        ...
                                        Zenoss.remote.FujitsuRouter.addFujitsuLogicalDiskRouter(opts,
                                        function(response) {
                                            if (response.success) {
                                                new Zenoss.dialog.SimpleMessageDialog({
                                                    title: _t('Logical Disk Added'),
